...
function acc_weapon_balance_mult( weapon_name )
{
    ...
    if ( IsSubStr( weapon_name, "apex_lstar" ) )              return 0.2754; // [wonder] THE CYBERJACK (apex_lstar / L-STAR chassis, docs/43). IDENTITY RESHAPE (user 2026-08-03 "nerf all charge up stages by 25% and buff the actually shooting by 50%" - the GUN is the point now, the charge nuke less so): this bullet-stream mult 0.1836 -> 0.2754 (x1.5; net vs the played 0.216 build = +27.5%), while the tornado charge stages took x0.75 in their own lanes (_acc_cyberjack storm bases). History: 2026-08-03 overall -15% (0.216 -> 0.1836), 2026-08-01 all-around -25% (0.288 -> 0.216), 2026-07-27 all-lane -10% "they are just too good" (0.32 -> 0.288). (250 @ 0.084 x 0.2754 x 3.25 = ~223.8/shot ~= 2664 eff DPS base; PaP tiers multiply via pap_tier_mult at :990 - get_tier reads cyberjack_tier, so the in-place PaP damage ladder applies automatically; the jack-in chain hops fire the held weapon so they inherit this mult too - "the actual shooting" includes the chain). v4.3 GDT: clip 60 / 8 mags (480), pen LARGE (through-zombie pierce), tight hip spread, energy muzzle flash. The WONDER-ness is chain + DoT + tornado (exact-marked, untouched by this mult - tuned in their own lanes). PLAYTEST-TUNE HERE.
