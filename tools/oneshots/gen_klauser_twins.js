// Hand-generate the 6 perk twins for the VG Klauser (recoil50 / fastreload / recoil50_fastreload
// x base+_up), mirroring apply_recoil_overhaul.js but ONLY for this gun (so the hand-built twins -
// Blast-O-Matic / XM4 / Streetsweeper - are untouched). Applies the map's recoil x1.75 baseline in
// place first (keeps .acc-orig; the optic-strip is already in the current GDT so twins are optic-free),
// then clones twins into BOTH the repo and deployed acc_weapon_variants.gdt.
...
const guns = [
  { src: TOOLS + '/source_data/skye_s4_klauser.gdt', base: 's4_klauser', up: 's4_klauser_up' },
];
