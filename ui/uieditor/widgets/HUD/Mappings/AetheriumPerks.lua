...
CoD.AetheriumPerks = {
	...
	},
	{
		...
		megaBenefits = { "Revive even faster", "Regen starts even sooner", "Faster near allies", "Shielded while reviving" },
		megaFullBenefits = { "Revive even faster", "Regen starts even sooner", "Revive yourself solo", "Faster near allies", "Shielded while reviving" },
		bit = 1,
	...
	},
	{
		...
		megaDescription = "Shoots even faster, swap weapons faster",
		benefits = { "Fires extra bullets", "Shoots faster" },
		megaBenefits = { "Shoots even faster", "Swap weapons faster" },
		megaFullBenefits = { "Fires extra bullets", "Shoots even faster", "Swap weapons faster" },
		bit = 3,
	...
	},
	{
		...
		megaName = "PhD Slider",
		megaDescription = "Slide to explode, bigger explosions",
		benefits = { "No fall or blast damage", "Explode when downed" },
		megaBenefits = { "Slide to explode", "Bigger explosions", "Move faster" },
		megaFullBenefits = { "No fall or blast damage", "Slide to explode", "Explode when downed", "Bigger explosions", "Move faster" },
		bit = 8,
