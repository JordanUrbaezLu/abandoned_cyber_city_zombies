...
| **Perk-icon shaders** | Ronan (Cyberpunk Shaders) | 16 perk HUD icons (`i_acc_perk_*`) | ⚠️ Currently **uncommitted** in `source_data\acc_perk_shaders*`; comes with the zip. Deploy via [`tools/deploy_perk_shaders.ps1`](tools/deploy_perk_shaders.ps1) | `source_data\acc_perk_shaders.gdt`, `source_data\acc_perk_shaders\` |
...
> is done. The single source of truth for the pack paths is
> [`tools/external_assets_manifest.ps1`](tools/external_assets_manifest.ps1).
...
Full list + recipes: [docs/34_flags_reference.md](docs/34_flags_reference.md)
...
| All dev/test/tuning flags (dvars) | [docs/34_flags_reference.md](docs/34_flags_reference.md) |
