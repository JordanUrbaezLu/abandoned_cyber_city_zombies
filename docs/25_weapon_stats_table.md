...
## Formula (verified from `_acc_damage.gsc::on_ai_damage`, 2026-07-18)
...
- **Box %** = per-open mystery-box pull chance, parsed from `_acc_map_randomizer.gsc::acc_box_weight` (weight / pool-total 4993 x gun-share 0.985, i.e. after the Monkey Bomb 1.0% + Li'l Arnie 0.5% fixed tactical pre-roll). This is the FRESH-pool chance; it re-normalizes UP live as you collect (owned guns drop out).
...
|---|---|--:|--|:--:|--:|--:|--:|--|--:|--:|---|
| **Thundergun** | Wonder (WW) | 0.24% | 10000 / 15000 / 20000 | 1/game | 0 (fling) | 0.45 | — | 4 / 24 | 0.95s | ×0.86 | maxHP-fraction blast (thundergun_boss_blast) |
| **Fire Bow** | Wonder (bow) | 0.24% | 10000 / 15000 / 20000 | 1/game | TAP 2233/1116 blast | 0.585 | HOLD = DoT (see vs Boss) | 75 / regen | 0.45s | ×0.93 | Charged portal = DAMAGE-OVER-TIME zone (2026-07-08): zombies/elites frac×roundHP/s (frac 0.117→0.2925 by tier), BOSSES maxHP/div/s (÷137→÷69 by tier) + chompers. Furies: arrow hit = guaranteed one-shot. |
| **Leviathan Axe** | Wonder (melee) | 0.24% | 10000 / 15000 / 20000 | 1/game | — (per-enemy) | 1 | — | — / — | 0.594s | ×1.07 | hits-to-kill: zombie 1 · glitch 1 · shielded 4→2 · Fury 2→1 (→ = at 2nd PaP+) · **boss 24/20/18/14** (t0/T1/T2/T3) |
| **Blast-O-Matic** | Wonder (energy) | 0.24% | 10000 / 15000 / 20000 | 1/game | 3500 | 0.24 | 2730 | 20 / 110 | 0.16s | ×1 | x0.75 + 10% per-hit cap |
| **Action Figure** | Melee | 0.79% | 5000 / 7500 / 10000 | — | 5000 melee | — | — | — / — | 0.85s | ×1.07 | 1/33 maxHP/hit (~33 hits, acc_af_boss_hits) |
| **Winter's Howl** | Wonder (freeze) | 0.24% | 10000 / 15000 / 20000 | 1/game | 1035/518 cone (in/out) | — | T0 1035/518 · T3 2587/1295 (×3.25 global on top) | 12 / 108 | 0.08s | ×1.07 | 17.5% MOVE SLOW for 5s per hit (the headline UTILITY use; acc_freeze_boss_slow_rate 0.825 / _sec 5; a re-hit RESETS the timer, never stacks) - NOT a damage boss-killer (modest cone damage, 10% per-hit boss cap still backstops it; no iceover/shatter on bosses). |
| **Ballistic Knife** | Special (throw + stab) | 1.81% | 5000 / 7500 / 10000 | — | 1000 throw / 1000 stab | — | scripted | 1 / 9 | 0.5s | ×1 | capped CHIP only (never a delete): normal chain × throw ×6 / stab ×2 + the Exo melee layer (both attacks), then the 10% maxHP/hit cap (≥10 hits). The one-hit does NOT apply to bosses/mini-bosses/Fury. |
...
|---|---|:--:|--:|--:|--|--:|--:|--:|--:|---|---|--:|--:|--:|:--|--:|
| **Havoc** | AR (energy, full-auto) | — / TOP | - | 1.18% | 5000 / 7500 / 10000 | 300 | 0.340264 | 40 | 320 | 442 / 553 / 664 | 663 / 830 / 996 | 0.107s | 3.864s | ×0.93 | 🟡 Medium · ↑58 ↔50 | 3261 |
| **XM4** | AR | A / TOP | 6.14 | 1.26% | 5000 / 7500 / 10000 | 360 | 0.2079 | 55 | 550 | 324 / 405 / 486 | 810 / 1013 / 1215 | 0.07s | 3s | ×0.93 | 🔴 Very High · ↑70 ↔105 | 3902 |
| **AK-47** | AR | C / TOP | 5.69 | 1.56% | 5000 / 7500 / 10000 | 300 | 0.266211 | 31 | 341 | 346 / 433 / 519 | 865 / 1083 / 1298 | 0.08s | 3.25s | ×0.93 | 🟠 High · ↑26 ↔105 | 2808 |
| **AE4** | AR | A / MID | 5.87 | 4.62% | 4000 / 6000 / 8000 | 290 | 0.3069 | 38 | 304 | 386 / 482 / 579 | 965 / 1205 / 1448 | 0.12s | 3s | ×0.93 | 🟠 High · ↑26 ↔105 | 2910 |
| **Grav** | AR | B / BOT | 5.72 | 6.04% | 3000 / 4500 / 6000 | 340 | 0.165 | 35 | 420 | 243 / 304 / 365 | 608 / 760 / 913 | 0.075s | 2.925s | ×0.93 | 🟢 Low · ↑16 ↔64 | 2302 |

### Marksman & Sniper

| Gun | Class | Tier | Score | Box % | PaP cost T1/T2/T3 | raw | bal | Clip | Reserve | Body T1/T2/T3 | Head T1/T2/T3 | fireTime | reload | Move | Recoil (control) | DPS |
|---|---|:--:|--:|--:|--|--:|--:|--:|--:|---|---|--:|--:|--:|:--|--:|
| **MORS** | Sniper | C / TOP | 4.67 | 2.62% | 5000 / 7500 / 10000 | 1500 | 0.25688 | 1 | 61 | 1670 / 2087 / 2505 | 4175 / 5218 / 6263 | 0.05s | 1.2s | ×0.93 | 🟢 Low · ↑4 ↔83 | 2004 |
| **Triple Take** | Sniper (3-bolt volley) | A / MID | 7.19 | 4.91% | 4000 / 6000 / 8000 | 500 | 0.356571875 | 15 | 180 | 773 / 966 / 1159/bolt | 1933 / 2415 / 2898 | 0.110592s | 3.4s | ×0.93 | 🟠 High · ↑84 ↔44 | 10310 (×3 bolts) |
| **MK14** | DMR | B / BOT | 6.53 | 4.99% | 3000 / 4500 / 6000 | 600 | 0.28809 | 12 | 240 | 749 / 936 / 1124 | 1873 / 2340 / 2810 | 0.095s | 2s | ×0.93 | 🟡 Medium · ↑22 ↔89 | 4296 |

### Shotgun

| Gun | Class | Tier | Score | Box % | PaP cost T1/T2/T3 | raw | bal | Clip | Reserve | Body T1/T2/T3 | Head T1/T2/T3 | fireTime | reload | Move | Recoil (control) | DPS |
|---|---|:--:|--:|--:|--|--:|--:|--:|--:|---|---|--:|--:|--:|:--|--:|
| **Peacekeeper** | Shotgun | A / TOP | 7.30 | 1.40% | 5000 / 7500 / 10000 | 340 | 0.41624 | 8 | 80 | 613 / 767 / 920/pel | excluded* | 0.16s | 2.5s | ×1 | 🔴 Very High · ↑105 ↔60 | 23365 (×pel) |
| **CEL-3** | Shotgun | C / TOP | 5.87 | 4.81% | 5000 / 7500 / 10000 | 200 | 0.3888 | 12 | 96 | 337 / 421 / 505/pel | excluded* | 0.5s | 3.75s | ×1 | 🟡 Medium · ↑5 ↔95 | 7458 (×pel) |
| **Tac-19** | Shotgun | B / MID | 6.91 | 5.11% | 4000 / 6000 / 8000 | 174 | 0.49929 | 6 | 54 | 376 / 471 / 565/pel | excluded* | 0.3s | 0.467s | ×1 | 🔴 Very High · ↑123 ↔96 | 17944 (×pel) |
| **Streetsweeper** | Shotgun | A / BOT | 8.29 | 5.35% | 3000 / 4500 / 6000 | 610 | 0.106392 | 14 | 126 | 281 / 352 / 422/pel | excluded* | 0.15s | 0.675s | ×1 | 🟢 Very Low · ↑26 ↔0 | 25548 (×pel) |
| **Olympia** | Shotgun | B / BOT | 6.61 | 5.86% | 3000 / 4500 / 6000 | 260 | 0.41734 | 4 | 84 | 470 / 588 / 705/pel | excluded* | 0.283s | 1.75s | ×1 | 🟢 Low · ↑4 ↔83 | 11742 (×pel) |

### SMG

| Gun | Class | Tier | Score | Box % | PaP cost T1/T2/T3 | raw | bal | Clip | Reserve | Body T1/T2/T3 | Head T1/T2/T3 | fireTime | reload | Move | Recoil (control) | DPS |
|---|---|:--:|--:|--:|--|--:|--:|--:|--:|---|---|--:|--:|--:|:--|--:|
| **PPSH-41** | SMG | A / TOP | 7.52 | 1.91% | 5000 / 7500 / 10000 | 280 | 0.269225 | 60 | 540 | 327 / 408 / 490 | 818 / 1020 / 1225 | 0.048s | 1.575s | ×1 | 🟡 Medium · ↑13 ↔79 | 6599 |
| **Alternator** | SMG (PaP power) | C / BOT | 6.27 | 4.54% | 3000 / 4500 / 6000 | 170 | 0.646866 | 30 | 360 | 477 / 596 / 715 | 1193 / 1490 / 1788 | 0.134s | 1.9s | ×1 | 🟠 High · ↑26 ↔105 | 3623 |
| **AK-74u** | SMG | B / MID | 6.37 | 5.05% | 4000 / 6000 / 8000 | 312 | 0.22264 | 40 | 280 | 301 / 376 / 452 | 753 / 940 / 1130 | 0.08s | 1.764s | ×1 | 🟡 Medium · ↑22 ↔89 | 3642 |
| **Prowler** | SMG | A / BOT | 6.47 | 5.21% | 3000 / 4500 / 6000 | 135 | 0.54571 | 31 | 279 | 319 / 399 / 479 | 638 / 798 / 958 | 0.08s | 0.9s | ×1 | 🟢 Low · ↑18 ↔59 | 4393 |

### LMG

| Gun | Class | Tier | Score | Box % | PaP cost T1/T2/T3 | raw | bal | Clip | Reserve | Body T1/T2/T3 | Head T1/T2/T3 | fireTime | reload | Move | Recoil (control) | DPS |
|---|---|:--:|--:|--:|--|--:|--:|--:|--:|---|---|--:|--:|--:|:--|--:|
| **M60** | LMG | A / TOP | 6.61 | 1.72% | 5000 / 7500 / 10000 | 440 | 0.286649 | 120 | 600 | 547 / 683 / 820 | 1368 / 1708 / 2050 | 0.09s | 9.7s | ×0.86 | 🟡 Medium · ↑22 ↔96 | 4800 |
| **HAMR** | LMG | B / MID | 6.46 | 5.52% | 4000 / 6000 / 8000 | 390 | 0.208 | 100 | 500 | 352 / 439 / 527 | 880 / 1098 / 1318 | 0.08s | 6s | ×0.86 | 🟢 Low · ↑4 ↔83 | 3764 |
| **RPD** | LMG | C / MID | 5.72 | 5.68% | 4000 / 6000 / 8000 | 468 | 0.13213 | 125 | 625 | 268 / 335 / 402 | 670 / 838 / 1005 | 0.0696s | 7.5s | ×0.86 | 🟡 Medium · ↑13 ↔88 | 3102 |

### Pistol

| Gun | Class | Tier | Score | Box % | PaP cost T1/T2/T3 | raw | bal | Clip | Reserve | Body T1/T2/T3 | Head T1/T2/T3 | fireTime | reload | Move | Recoil (control) | DPS |
|---|---|:--:|--:|--:|--|--:|--:|--:|--:|---|---|--:|--:|--:|:--|--:|
| **RW1** | Pistol | B / MID | 6.56 | 4.71% | 4000 / 6000 / 8000 | 1000 | 0.15972 | 12 | 96 | 692 / 865 / 1038 | 1730 / 2163 / 2595 | 0.15s | 1.4s | ×1.07 | 🟢 Low · ↑4 ↔83 | 3893 |
| **Five-Seven** | Pistol (start) | A / BOT | 7.27 | 6.16% | 3000 / 4500 / 6000 | 455 | 0.27742 | 27 | 189 | 547 / 684 / 820 | 1368 / 1710 / 2050 | 0.08s | 1.8s | ×1.07 | 🟢 Low · ↑4 ↔83 | 5591 |

### Launcher

| Gun | Class | Tier | Score | Box % | PaP cost T1/T2/T3 | raw | bal | Clip | Reserve | Body T1/T2/T3 | Head T1/T2/T3 | fireTime | reload | Move | Recoil (control) | DPS |
|---|---|:--:|--:|--:|--|--:|--:|--:|--:|---|---|--:|--:|--:|:--|--:|
| **Mahem** | Launcher | — / TOP | - | 2.13% | 5000 / 7500 / 10000 | 7000 | 0.1099 | 8 | 24 | 3334 / 4167 / 5000 | 6668 / 8334 / 10000 | 0.4s | 3.5s | ×0.86 | 🟢 Low · ↑48 ↔25 | 5970 |
| **War Machine** | Launcher | — / TOP | - | 2.37% | 5000 / 7500 / 10000 | 7000 | 0.10636 | 12 | 72 | 3226 / 4033 / 4839 | 6452 / 8066 / 9678 | 0.25s | 3.75s | ×0.86 | 🟢 Low · ↑48 ↔25 | 8603 |
