...
| Trench health (per layer) | max health while in the trench (on top of round health) | **+30% per layer** (L1 +30% … L5 +150%; one-way, deepest layer reached) | `_acc_zombie_speed.gsc` `apply_trench_health` / dvar `acc_trench_layer_hp_pct` |
